...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "InfiniteCardsBlock".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "InfiniteCardsBlock_select".
 */
...
export interface Header {
  ...
  navItems?:
    | {
        ...
        /**
         * Optional image for this main nav link
         */
        image?: (number | null) | Media;
        /**
         * Add dropdown subcategories with internal page links or external URLs
         */
        subcategories?:
          | {
              label: string;
