...
export async function up({ db, payload: _payload, req: _req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('en', 'rs');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_infinite_cards_cards" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_infinite_cards" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_infinite_cards_cards" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_infinite_cards" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "header_nav_items_subcategories" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_infinite_cards_cards" ADD CONSTRAINT "pages_blocks_infinite_cards_cards_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_infinite_cards_cards" ADD CONSTRAINT "pages_blocks_infinite_cards_cards_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_infinite_cards"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_infinite_cards" ADD CONSTRAINT "pages_blocks_infinite_cards_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_infinite_cards_cards" ADD CONSTRAINT "_pages_v_blocks_infinite_cards_cards_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_infinite_cards_cards" ADD CONSTRAINT "_pages_v_blocks_infinite_cards_cards_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_infinite_cards"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_infinite_cards" ADD CONSTRAINT "_pages_v_blocks_infinite_cards_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "header_nav_items_subcategories" ADD CONSTRAINT "header_nav_items_subcategories_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."header_nav_items"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_carousel_slides_locale_idx" ON "pages_blocks_carousel_slides" USING btree ("_locale");
  CREATE INDEX IF NOT EXISTS "pages_blocks_carousel_slides_image_idx" ON "pages_blocks_carousel_slides" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_infinite_cards_cards_order_idx" ON "pages_blocks_infinite_cards_cards" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_infinite_cards_cards_parent_id_idx" ON "pages_blocks_infinite_cards_cards" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_infinite_cards_cards_locale_idx" ON "pages_blocks_infinite_cards_cards" USING btree ("_locale");
  CREATE INDEX IF NOT EXISTS "pages_blocks_infinite_cards_cards_image_idx" ON "pages_blocks_infinite_cards_cards" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_infinite_cards_order_idx" ON "pages_blocks_infinite_cards" USING btree ("_order");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_carousel_slides_order_idx" ON "_pages_v_blocks_carousel_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_carousel_slides_parent_id_idx" ON "_pages_v_blocks_carousel_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_carousel_slides_locale_idx" ON "_pages_v_blocks_carousel_slides" USING btree ("_locale");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_carousel_slides_image_idx" ON "_pages_v_blocks_carousel_slides" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_infinite_cards_cards_order_idx" ON "_pages_v_blocks_infinite_cards_cards" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_infinite_cards_cards_parent_id_idx" ON "_pages_v_blocks_infinite_cards_cards" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_infinite_cards_cards_locale_idx" ON "_pages_v_blocks_infinite_cards_cards" USING btree ("_locale");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_infinite_cards_cards_image_idx" ON "_pages_v_blocks_infinite_cards_cards" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_infinite_cards_order_idx" ON "_pages_v_blocks_infinite_cards" USING btree ("_order");
  ...
  CREATE INDEX IF NOT EXISTS "header_nav_items_subcategories_order_idx" ON "header_nav_items_subcategories" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "header_nav_items_subcategories_parent_id_idx" ON "header_nav_items_subcategories" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "header_nav_items_subcategories_locale_idx" ON "header_nav_items_subcategories" USING btree ("_locale");
...
export async function down({ db, payload: _payload, req: _req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "header_nav_items_subcategories" CASCADE;
